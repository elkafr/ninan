...
import 'package:ninan/models/notification_item.dart';
 ...
 Future<List<NotificationItem>> _notificationList;
  ...
  Future<List<NotificationItem>> _getNotifications() async {
    Map<String, dynamic> results =
        await _services.get('https://ninanapp.com/app/api/my_inbox1?page=1&user_id=${_appState.currentUser.userId}&lang=${_appState.currentLang}');
