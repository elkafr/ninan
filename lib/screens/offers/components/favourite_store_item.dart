...
import 'package:ninan/models/favourite_store.dart';
              ...
              child: IconButton(
                ...
                onPressed: () async {
                  ...
                  var results = await _services.get(
                      'https://works.rawa8.com/apps/ninan//api/delete_save_ads?mtger_id=${widget.favouriteStore.mtgerId}&user_id=${appState.currentUser.userId}&lang=${appState.currentLang}');
