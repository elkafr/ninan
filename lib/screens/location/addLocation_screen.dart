...
import 'package:ninan/models/titles.dart';
...
class _AddLocationScreenState extends State<AddLocationScreen> {
  ...
  Future<List<Titles>> _getTitlesList() async {
    ...
    await _services.get('https://ninanapp.com/app/api/gettitles?lang=${_appState.currentLang}');
      ...
      if (_locationState.locationLatitude == null ||
        ...
        if(isSwitched==true){
          ...
          var results = await _services.get(
            'https://ninanapp.com/app/api/addLocation?lang=${_appState.currentLang}&location_titles=${_appState.selectTab}&location_details=$_adress&location_mapx=${_locationState.locationLatitude}&location_mapy=${_locationState.locationlongitude}&location_user=${_appState.currentUser.userId}',
          );
