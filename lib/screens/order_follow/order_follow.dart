...
import 'package:ninan/screens/orders/components/cancel_order_bottom_sheet.dart';
import 'package:ninan/services/access_api.dart';
import 'package:ninan/utils/app_colors.dart';
import 'package:url_launcher/url_launcher.dart';
import 'package:ninan/screens/chat/chat_screen.dart';
import 'package:ninan/screens/chat/widgets/chat_msg_item.dart';
            ...
            child: ListTile(
              ...
              title: Column(
                ...
                children: <Widget>[
                  ...
                  Text(order.carttTawsilDate+" "+order.carttTawsilTime,style: TextStyle(color: cWhite,fontSize: 17,fontWeight: FontWeight.bold),),
            ...
            Container(
              ...
              child: ListTile(
                ...
                title: Column(
                  ...
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: <Widget>[
                    Text(order.carttMtgerName,style: TextStyle(color: cBlack,fontSize: 15),),
                    SizedBox(height: _width*.03,),
